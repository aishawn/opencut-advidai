...
"[project]/apps/web/src/lib/storage/storage-service.ts [app-ssr] (ecmascript, async loader)": ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.resolve().then(() => {
        return parentImport("[project]/apps/web/src/lib/storage/storage-service.ts [app-ssr] (ecmascript)");
    });
});
}),
